...
package com.reloaded.support.preferences;

import com.reloaded.support.R;
...
public class SimpleCustomSystemSeekBarPreference extends CustomSystemSeekBarPreference {

    public SimpleCustomSystemSeekBarPreference(Context context, AttributeSet attrs,
            int defStyleAttr) {
    ...
    public SimpleCustomSystemSeekBarPreference(Context context) {
        this(context, null);
    }
